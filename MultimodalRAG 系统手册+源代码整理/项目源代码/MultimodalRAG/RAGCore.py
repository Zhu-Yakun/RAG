...
class Generator:
    ...
    def _build_messages(self, query: str, context: List[Dict[str, Any]]) -> List[Dict[str, str]]:
        ...
        system_prompt_instructions = [
            ...
            "2.  **Handling Insufficient Information:** If the 'Reference Documents' do not contain the necessary information to answer the user's question, or if the question is unrelated to all provided documents, you MUST first state: \"I could not find relevant information in the knowledge base. The following answer is based on my general knowledge and may not be professionally accurate.\" After this disclaimer, you may answer the question based on your general knowledge and understanding. Ensure your response clearly distinguishes that it is not based on the provided documents.",
